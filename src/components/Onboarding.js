...
export default function Onboarding({setOnboarding}) {
  ...
  return (
    ...
    {currentScreen == 1 && (
      <div className="onBoardingScreen">
        <h1 className="onBoardingTxt txtPrimary">
          Choose from a{" "}
          <span className="txtSecondary">hand picked</span> library of
          Spirographs
        </h1>
    ...
    {currentScreen == 2 && (
      <div className="onBoardingScreen">
        <h1 className="onBoardingTxt txtPrimary">
          Get your creative juice running by creating spirographs that
          are <span className="txtSecondary">unique</span> to you
        </h1>
